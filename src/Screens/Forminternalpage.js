...
const Forminternalpage = ({ navigation }) => {
  const insets = useSafeAreaInsets();
  const [selectedOption, setSelectedOption] = useState('#2536215132');
  const [formType, setFormType] = useState('Type A');
  const [customerName, setCustomerName] = useState('Ethan Carter');
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Image source={require('../Asset/Images/c5.jpg')} style={{width:100,height:100,borderRadius:50,alignSelf:"center",marginTop:20}} />

        {/* Customer Header Section */}
        <View style={styles.customerHeader}>
          <Text style={styles.customerName}>Naomi Carter</Text>
