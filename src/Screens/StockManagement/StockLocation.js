...
const LOCATION_DATA = [
  ...
  {id: '2', location: 'Budgam', units: 6},
   { id: '3', location: 'Aachabal', units: 3 },
  { id: '4', location: 'HO Awantipura', units: 12 },
  {id: '5', location: 'Ganderbal', units: 4},
  {id: '6', location: 'Budgam', units: 6},
   { id: '7', location: 'Aachabal', units: 3 },
  { id: '8', location: 'HO Awantipura', units: 12 },
];
  ...
  const renderLocation = ({item}) => (
      <LinearGradient
        ...
        <View style={styles.locationRow}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("StockLocationList")}
            style={{
